...
| A4-3 | 정책 호스팅 | 🧑 (URL 발급) → `[[개인정보처리방침 URL]]` |
...
| A8-2 | 지원 URL(Support URL) | 🧑 → `[[지원 URL]]` |
| A8-3 | 연령 등급(아래 §D) | 🧑+🤖 |
| A8-4 | 앱 설명·키워드·프로모션 텍스트(한/영) | 🤖 초안 / 🧑 입력 |
| A8-5 | 저작권·판매자 정보 | 🧑 → `[[판매자/개인 사업자명]]` |
...
| # | 항목 | 담당 |
|---|---|---|
| B6-1 | 개인정보처리방침 URL(Store listing + Data safety 양쪽) | 🧑 → `[[개인정보처리방침 URL]]` |
...
| 플레이스홀더 | 용도 | 담당 |
|---|---|---|
| `[[개인정보처리방침 URL]]` | App Store Connect / Play Store listing / Data safety / OAuth 동의 화면 | 🧑 |
| `[[지원 URL]]` | iOS Support URL / 사용자 문의 채널 | 🧑 |
| `[[지원 이메일]]` | OAuth 동의 화면 지원 이메일 / 스토어 연락처 | 🧑 |
| `[[홈페이지 URL]]` | OAuth 동의 화면 앱 홈페이지(선택) | 🧑 |
| `[[판매자/개인 사업자명]]` | App Store 판매자 정보 / 저작권 표기 | 🧑 |
| `[[시행일]]` | 정책 시행일(정책 문서와 일치) | 🧑 |
| `[[피처 그래픽 1024×500]]` | Google Play 필수 그래픽 (현재 미보유, 제작 필요) | 🤖 제작 / 🧑 업로드 |
| `[[데이터 삭제 요청 채널]]` | 인앱 직접 삭제(설정 → 데이터 → "내 데이터 삭제")에 더해 Data safety "삭제 요청 방법"에 기재할 보조 문의 경로 | 🧑 |
