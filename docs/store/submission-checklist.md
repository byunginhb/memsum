...
| A4-3 | 정책 호스팅 | 🧑 (URL 발급) → `https://byunginhb.github.io/memsum/privacy.html` |
...
| A8-2 | 지원 URL(Support URL) | 🧑 → `https://byunginhb.github.io/memsum/` |
| A8-3 | 연령 등급(아래 §D) | 🧑+🤖 |
...
| # | 항목 | 담당 |
|---|---|---|
| B6-1 | 개인정보처리방침 URL(Store listing + Data safety 양쪽) | 🧑 → `https://byunginhb.github.io/memsum/privacy.html` |
...
| 플레이스홀더 | 용도 | 담당 |
|---|---|---|
| `https://byunginhb.github.io/memsum/privacy.html` | App Store Connect / Play Store listing / Data safety / OAuth 동의 화면 | 🧑 |
| `https://byunginhb.github.io/memsum/` | iOS Support URL / 사용자 문의 채널 | 🧑 |
| `byunginhb@gmail.com` | OAuth 동의 화면 지원 이메일 / 스토어 연락처 | 🧑 |
| `https://byunginhb.github.io/memsum/` | OAuth 동의 화면 앱 홈페이지(선택) | 🧑 |
