...
- 서비스명: Memsum
- 개인정보 보호책임자(또는 운영자): [[운영자/사업자명]]
- 이메일(문의처): [[지원 이메일 주소]]
- 정책 게시 URL: [[개인정보처리방침 호스팅 URL]]
...
## 채워야 할 항목 (배포 전 반드시 확정)

- [[시행일 YYYY-MM-DD]] — 정책 시행일
- [[최종 수정일 YYYY-MM-DD]] — 정책 최종 수정일
- [[운영자/사업자명]] — 개인정보 보호책임자(개인 또는 사업자명)
- [[지원 이메일 주소]] — 이용자 문의·권리 행사 접수용 이메일
- [[개인정보처리방침 호스팅 URL]] — 스토어 제출 시 입력할 정책 공개 URL
